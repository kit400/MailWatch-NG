...
--
CREATE DATABASE IF NOT EXISTS `mailscanner` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
USE `mailscanner`;
...
CREATE TABLE IF NOT EXISTS `blacklist` (
  ...
  `to_domain` text COLLATE utf8mb4_unicode_ci,
...
CREATE TABLE IF NOT EXISTS `inq` (
  ...
  `priority` mediumtext COLLATE utf8mb4_unicode_ci,
  `attempts` mediumtext COLLATE utf8mb4_unicode_ci,
  `lastattempt` mediumtext COLLATE utf8mb4_unicode_ci,
  `hostname` mediumtext COLLATE utf8mb4_unicode_ci,
  PRIMARY KEY (`inq_id`),
...
CREATE TABLE IF NOT EXISTS `maillog` (
  ...
  `from_address` mediumtext COLLATE utf8mb4_unicode_ci,
  `from_domain` mediumtext COLLATE utf8mb4_unicode_ci,
  `to_address` mediumtext COLLATE utf8mb4_unicode_ci,
  `to_domain` mediumtext COLLATE utf8mb4_unicode_ci,
  `subject` mediumtext COLLATE utf8mb4_unicode_ci,
  `clientip` mediumtext COLLATE utf8mb4_unicode_ci,
  ...
  `mcpreport` mediumtext COLLATE utf8mb4_unicode_ci,
  `hostname` mediumtext COLLATE utf8mb4_unicode_ci,
  `date` date DEFAULT NULL,
  `time` time DEFAULT NULL,
  `headers` mediumtext COLLATE utf8mb4_unicode_ci,
  `messageid` mediumtext COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `quarantined` tinyint(1) DEFAULT '0',
  `rblspamreport` mediumtext COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `mcp_rules` (
  `rule` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
  `rule_desc` varchar(512) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
  PRIMARY KEY (`rule`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE IF NOT EXISTS `mtalog` (
  ...
  `relay` mediumtext COLLATE utf8mb4_unicode_ci,
  `dsn` mediumtext COLLATE utf8mb4_unicode_ci,
  `status` mediumtext COLLATE utf8mb4_unicode_ci,
  `delay` time DEFAULT NULL,
  `to_address` mediumtext COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `saved_filters` (
  ...
  `operator` mediumtext COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE IF NOT EXISTS `users` (
  ...
  `resetexpire` bigint(20) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `lastreset` bigint(20) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `login_expiry` bigint(20) COLLATE utf8mb4_unicode_ci DEFAULT '-1',
  `last_login` bigint(20) COLLATE utf8mb4_unicode_ci DEFAULT '-1',
  `login_timeout` smallint(5) COLLATE utf8mb4_unicode_ci DEFAULT '-1',
