...
function printNavBar()
{
    ...
    if ('A' === ($_SESSION['user_type'] ?? '')) {
        ...
        echo '    <span class="nav-gear-icon">' . mw_icon('gear', '', 17) . '</span>' . "\n";
        echo '    <span class="nav-caret">' . mw_icon('caret', '', 10) . '</span>' . "\n";
        echo '  </button>' . "\n";
